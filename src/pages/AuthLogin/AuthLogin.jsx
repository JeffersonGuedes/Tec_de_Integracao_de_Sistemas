...
function AuthLogin() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            localStorage.setItem('notification', JSON.stringify({ color: 'danger', text: "CPF ou senha incorretos. Por favor, tente novamente" }));
        ...
        <>
            ...
            <form onSubmit={handleSubmit} className="flex justify-center items-center h-screen mx-[10vw]">
                <CardLogin title="New">
                    ...
                    />
                    <Link to="/auth_reset" className="w-full flex mt-3 font-[var(--font-primary)] font-bold underline underline-offset-2 decoration-1 cursor-pointer hover:text-[var(--color-gray-3)] content-center justify-end">Esqueci minha senha?</Link>
                </CardLogin>
            </form>
        </>
    )
